				...
				{projects.map((project) => (
					...
					>
						...
						<div className="absolute inset-0 p-6 flex flex-col justify-end">
							...
							<p className="text-xs md:text-base text-gray-300 mb-4">{project.description}</p>
							<div className="flex gap-4">
								<Link href={"/project/" + project.id } className="text-sm px-4 py-2 bg-white/10 hover:bg-white/20 rounded-full transition-colors">
									View Project
								</Link>
								{project.github != '' && 
